...
<?php if($settings->navigation_type==1) { require_once $abs_us_root.$us_url_root.'users/includes/database-navigation.php'; } //Add database navigation if selected ?>
